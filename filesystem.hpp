...
// If we're compiling on Visual Studio and are not compiling with C++17, we still need to use experimental
#       ifdef _MSC_VER
...
// We need the alias from std::experimental::filesystem to fs
